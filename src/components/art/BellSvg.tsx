/* Hook-free temple bell artwork — shared by the client component and the invitation card. */
...
/** Temple bell on a chain; swings with the .sway keyframe. Pure function for card rendering. */
export function BellSvg({ id, className, style, delay = 0 }: BellProps & { id: string }) {
  const brass = `bell-${id}`;
  return (
